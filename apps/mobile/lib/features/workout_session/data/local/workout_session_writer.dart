...
class WorkoutSessionWriter {
  ...
  /// Efface une série : pierre tombale locale, prévision rendue au plan, et
  /// `set.delete` en file.
  ///
  /// Extraite du dépôt pour la même raison que [correctSet] et [addSet] : la
  /// règle du dépôt borne la MÉTHODE de repository à 40 lignes, et
  /// l'écriture d'une série — trois tables et une opération de
  /// synchronisation — n'y tient pas. Les deux chemins d'écriture d'une
  /// série vivent désormais côte à côte, ce qui est aussi le bon endroit
  /// pour les comparer.
