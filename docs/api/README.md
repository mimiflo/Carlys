...
| Notifications | **Livré** — `POST /api/v1/notifications/device-tokens` (204, enregistrement rejouable), `DELETE /notifications/device-tokens` (204, à la déconnexion) ; l'envoi part côté serveur via FCM, voir `docs/product/notifications.md` | Post-Étape 7 ✅ |
