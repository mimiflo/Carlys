...
| Repas | **Livré** — `POST /api/v1/nutrition/meals` (201, création idempotente par id appareil), `GET /nutrition/meals` (journal entre deux instants, plage plafonnée à 366 jours et 10 000 lignes), `DELETE /nutrition/meals/:id` (204) — alimente les kcal consommées de l'accueil | Post-Étape 7 ✅ |
